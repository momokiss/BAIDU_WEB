    ...
    <div :class="$style.wrapper">
      ...
      <div v-if="myPositions.length" :class="$style.block">
        ...
        <div :class="$style.my_positions">
          <MyPositionCard v-for="position in myPositions" :key="position.id" :event="position.event" />
        </div>
      </div>
      ...
      <div v-if="marketStore.isMarketsLoaded" :class="$style.block">
        ...
        <div :class="$style.items">
          <MarketCard v-for="market in marketStore.markets" :key="market.id" :market="market" />
        </div>
      </div>
      ...
      <div :class="$style.block">
        ...
        <RatingCard v-if="!isTopProvidersLoading" :users="topProviders" suffix="ꜩ" :class="$style.rating_card" />
      ...
      <div :class="$style.block">
        <div :class="$style.head">
          ...
          <Button @click="handleViewTopEvents" size="small" type="secondary">
        ...
        <transition name="fastfade" mode="out-in">
          <div v-if="marketStore.events.length" :class="$style.items">
            <EventCard v-for="event in marketStore.events" :key="event.id" :event="event" />
          </div>
      ...
      <div :class="$style.block">
        ...
        <RatingCard v-if="!isTopBettorsLoading" :users="topBettors" suffix="Bets" :class="$style.rating_card" />
        <RatingCardLoading v-else :class="$style.rating_card" />
      </div>
    </div>
  </transition>
