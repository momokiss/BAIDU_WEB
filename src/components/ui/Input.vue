...
<template>
  <div :class="$style.wrapper">
    ...
    <div ref="base" @click="handleClick" :class="[
      $style.base,
      isFocused && $style.focused,
      disabled && $style.disabled,
    ]">
      <input ref="input" :type="getInputType" v-model="text" @input="handleInput" @focus="handleFocus"
        @blur="handleBlur" @keydown="handleKeydown" :placeholder="placeholder" />
