...
<template>
	<Page :class="$style.wrapper">
		<img src="@/assets/landing/ga_bg.png" alt="bg" :class="$style.background_grad" />
		...
		<div :class="$style.content">
			...
			<div v-if="juster.sdk._network == 'ithacanet'" :class="$style.interactive_block">
				<Banner type="warning" color="yellow" size="small" center>You're currently on a testnet ({{
				...
				<Button @click="handleSwitch" type="secondary" size="medium" block :class="$style.switch_btn">
					<Icon name="network" size="16" />Switch to Mainnet
				</Button>
			...
			<div v-else :class="$style.interactive_block">
				<Banner icon="checkcircle" color="green" size="small" center>You are on the main network!</Banner>
			...
			<p>
				<b>All the business logic is implemented in the smart contract
					on Tezos:</b>
				...
				<i>Still please acknowledge the risks you take when using
			...
			<p>
				...
				roadmap and join
				<a href="https://discord.gg/FeGDCkHhnB" target="_blank">Juster Discord server</a>
		...
		<div :class="$style.buttons">
			...
			<a href="https://twitter.com/Juster_fi" target="_blank">
				<Button type="secondary" size="small">
					<Icon name="twitter" size="16" />Read our Twitter
				</Button>
			</a>
		</div>
	</Page>
